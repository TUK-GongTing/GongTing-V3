...
function fristDone(event) {
  ...
  let wishcount2Div = document.getElementById('wishcount2');
  let wishcount3Div = document.getElementById('wishcount3');
  let wishcount4Div = document.getElementById('wishcount4');

  let selectedElement2 = document.getElementById('two');
  let selectedElement3 = document.getElementById('three');
  
  if (selectedElement2 && selectedElement2.checked) {
      fristDiv.style.display = 'none';
      wishcount2Div .style.display = 'block';
  } else if(selectedElement3 && selectedElement3.checked) {
      fristDiv.style.display = 'none';
      wishcount3Div.style.display = 'block';
  } else{
    fristDiv.style.display = 'none';
    wishcount4Div.style.display = 'block';
  }
}
                ...
                function wishcount3Done(event) {
                  event.preventDefault();
                  let secondDiv = document.getElementById('wishcount3');
                  let thridDiv = document.getElementById('thrid');
                  secondDiv.style.display = 'none';
                  thridDiv.style.display = 'block';
                }
                function wishcount4Done(event) {
                  event.preventDefault();
                  let secondDiv = document.getElementById('wishcount4');
                  let thridDiv = document.getElementById('thrid');
                  secondDiv.style.display = 'none';
                  thridDiv.style.display = 'block';
                }
                ...
                function thridDone(event) {
                    event.preventDefault();
                    let thridDiv = document.getElementById('thrid');
                    let fourDiv = document.getElementById('fourdiv');
                    thridDiv.style.display = 'none';
                    fourDiv.style.display = 'block';
                }
